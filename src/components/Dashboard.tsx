...
export const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden pb-32">
      {/* Hero Section */}
      <ScrollReveal className="relative pt-24 pb-16 px-8 md:px-16 max-w-[1440px] mx-auto z-10" direction="down" distance={30}>
        <div className="inline-block px-3 py-1 mb-6 rounded-sm bg-text-primary/5 text-accent-primary text-xs font-mono uppercase tracking-widest border border-white/10">
          ⬡ Corporate Brandbook
        </div>
        ...
        <p className="text-lg md:text-xl text-text-secondary max-w-2xl font-body mb-12">
      ...
      <div className="px-8 md:px-16 max-w-[1440px] mx-auto z-10 relative">
        ...
        {/* Brand Summary Cards */}
        <ScrollReveal className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16 pt-16 border-t border-border-subtle" delay={0.4}>
          <div className="bg-bg-secondary border border-border-subtle rounded-xl p-8 text-center">
            <div className="text-xs text-text-tertiary uppercase tracking-widest mb-4 font-mono">Основано</div>
            <div className="text-3xl font-black text-accent-primary mb-1">Weekend</div>
            <div className="text-sm text-text-secondary">Billiard Company</div>
          </div>
          <div className="bg-bg-secondary border border-border-subtle rounded-xl p-8 text-center">
            <div className="text-xs text-text-tertiary uppercase tracking-widest mb-4 font-mono">Сфера</div>
            <div className="text-xl font-bold text-text-primary mb-2">Бильярдное оборудование</div>
            <div className="text-sm text-text-secondary">Продажа и доставка по РФ</div>
          </div>
          <div className="bg-bg-secondary border border-border-subtle rounded-xl p-8 text-center">
            <div className="text-xs text-text-tertiary uppercase tracking-widest mb-4 font-mono">Контакты</div>
            <div className="text-lg font-bold text-text-primary mb-2">weekend-billiard.ru</div>
            <div className="text-sm text-text-secondary">Москва · Санкт-Петербург</div>
          </div>
        </ScrollReveal>

        {/* Portal Statistics */}
        <ScrollReveal className="mt-16 pt-16 border-t border-border-subtle" delay={0.5}>
